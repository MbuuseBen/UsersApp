package com.example.usersapp.Payment;
...
import com.example.usersapp.Orders.FinishOrderActivity;
...
public class PaymentSelection extends AppCompatActivity {
    private TextView ConfirmBtn,ProceedBtn;
  //  private TextView f_Name,lName,userphone,useraddress,useremail ,editDetailsBtn,viewTotal;
   // private EditText specialText;
    ...
    private TextView subTotal,Totalamt,Taxamt;
...
//        totalAmount = getIntent().getIntExtra("TotalAmount",0);
        SpecialTxt = getIntent().getStringExtra("SpecialTxt");
...
//
        ...
        subTotal = (TextView) findViewById(R.id.subTotal_amt);
        Totalamt = (TextView) findViewById(R.id.total_amt);
        Taxamt = (TextView) findViewById(R.id.tax_amt);
        ConfirmBtn = (TextView) findViewById(R.id.delivery_confirm_btn);
...
//        useremail = findViewById(R.id.email_address);
        totalAmount1 = getIntent().getIntExtra("totalAmount",0);
        subTotal.setText("Ugx " +(new DecimalFormat("#,###").format(Integer.valueOf(totalAmount1))));
        Totalamt.setText("Ugx " +(new DecimalFormat("#,###").format(Integer.valueOf(totalAmount1))));
        Taxamt.setText("Ugx " +"");
    ...
    private void makePayment() {
        ...
        new RaveUiManager(PaymentSelection.this)
                .setAmount(Double.valueOf(totalAmount1))
...
//    }
        ...
        cartListRef.child("UserView").child(mAuth.getCurrentUser().getUid()).child("products").get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(PaymentSelection.this,"It dint work",Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void AddOrderInfo(HashMap products) {
     ...
     //   final String specialTxt = specialText.getText().toString();
        ...
        final DatabaseReference adminorderRef = FirebaseDatabase.getInstance().getReference().child("AdminOrders")
                .child(String.valueOf(uuid));

        HashMap<String, Object> ordersMap = new HashMap<>();
        ordersMap.put("totalAmount",totalAmount1);
        ...
        ordersMap.put("paymentType","Card_Momo");
        ...
        orderRef.updateChildren(ordersMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull @NotNull Task<Void> task) {
                if (task.isSuccessful()){
                    adminorderRef.updateChildren(ordersMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull @NotNull Task<Void> task) {
                            FirebaseDatabase.getInstance().getReference().child("Cart List")
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull @NotNull Task<Void> task) {
                                            if (task.isSuccessful()){
                                                Toast.makeText(PaymentSelection.this, "Your Final Order has been placed successfully", Toast.LENGTH_SHORT).show();

                                                Intent intent =  new Intent(PaymentSelection.this, FinishOrderActivity.class);
                                                intent.putExtra("totalAmount",totalAmount1);
                                                intent.putExtra("SpecialTxt",SpecialTxt);
    ...
    private void AddOrderInfo1(HashMap products) {
     ...
     //   final String specialTxt = specialText.getText().toString();
        ...
        ordersMap.put("time",saveCurrentTime);
        ordersMap.put("State", "pending");
        ordersMap.put("paymentType","CashOnDelivery");
        ordersMap.put("orderid", String.valueOf(uuid));
       // ordersMap.put("specialText", specialTxt);
        ordersMap.put("products", products);
