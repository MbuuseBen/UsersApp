...
private TextView order_id, Date,total_amount,Additional_text,item_count,orderState;
    private DatabaseReference cartListRef,orderDetailsRef;
...
//    private String text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference orderRef = FirebaseDatabase.getInstance().getReference().child("Orders").child(mAuth.getCurrentUser().getUid());
        ...
        ordersList = findViewById(R.id.products_list);
