...
public class ConfirmFinalOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button proceedToPaymentBtn = (Button) findViewById(R.id.place_order_btn);
...
//        CheckAddress();
   ...
   //     getDetails();
       ...
       // viewTotal.setText(cartTotal);
        ...
        viewTotal.setText("Ugx " +(new DecimalFormat("#,###").format(Integer.valueOf(totalAmount))));
        ...
        proceedToPaymentBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               // addTotaltoCart();
                //    makePayment();
                Intent intent = new Intent(ConfirmFinalOrderActivity.this, PaymentSelection.class);
