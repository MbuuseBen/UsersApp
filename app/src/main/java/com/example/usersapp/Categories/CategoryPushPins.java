...
//                startActivity(intent);
            ...
            case R.id.app_bar_search:
                Intent intent = new Intent(CategoryPushPins.this, NewSearchActivity.class);
                startActivity(intent);
            default:
                                                    ...
                                                    if (task.isSuccessful()) {
                                                        cartListRef.child("Orders View").child(mAuth.getCurrentUser().getUid())
                                                                ...
                                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                    ...
                                                                    public void onComplete(@NonNull @NotNull Task<Void> task) {
                                                                        if (task.isSuccessful()) {
                                                                            Toast.makeText(CategoryPushPins.this, "Added to Cart Successfully", Toast.LENGTH_SHORT).show();
