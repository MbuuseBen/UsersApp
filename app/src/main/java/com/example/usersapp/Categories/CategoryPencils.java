...
public class CategoryPencils extends AppCompatActivity {
    ...
    private RecyclerView searchList,pencils;
    private RecyclerView recyclerView,recyclerViewPencils;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_pencils);
        ...
        layoutPencils = new LinearLayoutManager(this,LinearLayoutManager.VERTICAL,false);
...
//                startActivity(intent);
            ...
            case R.id.app_bar_search:
                Intent intent = new Intent(CategoryPencils.this, NewSearchActivity.class);
                startActivity(intent);
            default:
...
//                holder.txtProductDescription.setText(model.getDescription());
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(CategoryPencils.this, ProductDetailsActivity.class);
