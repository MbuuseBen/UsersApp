...
public class CategoryStapler extends AppCompatActivity {

    private SearchView SearchBtn;
    private RecyclerView searchList,staplers;
    private RecyclerView recyclerView,recyclerViewStaplers;
    RecyclerView.LayoutManager layoutManager;
    RecyclerView.LayoutManager layoutStaplers;
    private FirebaseAuth mAuth;
    private TextView seeAllProducts;

    private String productID = "";

    private String categoryStaplers="stapler";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_stapler);
        mAuth = FirebaseAuth.getInstance();

        searchList = findViewById(R.id.search_list1);
        staplers = findViewById(R.id.category_stapler);


        recyclerView = findViewById(R.id.search_list1);
        recyclerViewStaplers = findViewById(R.id.category_stapler);



        productID = getIntent().getStringExtra("pid");

        layoutStaplers = new LinearLayoutManager(this,LinearLayoutManager.VERTICAL,false);
        recyclerViewStaplers.setLayoutManager(layoutStaplers);
        ...
        seeAllProducts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CategoryStapler.this, AllProductsActivity.class);
        ...
        productsRef.child(mAuth.getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Intent intent = new Intent(CategoryStapler.this, CartActivity.class);
                    startActivity(intent);


                }else {
                    Toast.makeText(CategoryStapler.this, "Please add some items to your cart.", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(CategoryStapler.this, MainActivity.class);
                    startActivity(intent);
...
//                startActivity(intent);
            ...
            case R.id.app_bar_search:
                Intent intent = new Intent(CategoryStapler.this, NewSearchActivity.class);
                startActivity(intent);
            default:
    ...
    private void loadTextbookstoRecyclerView() {
        ...
        Query query  =reference.orderByChild("category").equalTo(categoryStaplers);
        ...
        FirebaseRecyclerAdapter<Products, ProductViewHolder>
                adapterStapler = new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
            @Override
...
//                holder.txtProductDescription.setText(model.getDescription());
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(CategoryStapler.this, ProductDetailsActivity.class);
                        intent.putExtra("pid", model.getPid());
                        startActivity(intent);
                    }
                });
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull @NotNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                                            ...
                                                                            Toast.makeText(CategoryStapler.this, "Added to Cart Successfully", Toast.LENGTH_SHORT).show();
...
//                                                                                    finish();
        ...
        staplers.setAdapter(adapterStapler);
        adapterStapler.startListening();
    }
