...
public class CategoryPunch extends AppCompatActivity {

    private SearchView SearchBtn;
    private RecyclerView searchList,punch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_punch);
        mAuth = FirebaseAuth.getInstance();

        searchList = findViewById(R.id.search_list1);
        punch = findViewById(R.id.category_punch);


        recyclerView = findViewById(R.id.search_list1);
        recyclerViewPunch = findViewById(R.id.category_punch);



        productID = getIntent().getStringExtra("pid");

        layoutPunch = new LinearLayoutManager(this,LinearLayoutManager.VERTICAL,false);
        recyclerViewPunch.setLayoutManager(layoutPunch);
        ...
        productsRef.child(mAuth.getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Intent intent = new Intent(CategoryPunch.this, CartActivity.class);
                    startActivity(intent);


                }else {
                    Toast.makeText(CategoryPunch.this, "Please add some items to your cart.", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(CategoryPunch.this, MainActivity.class);
                    startActivity(intent);
...
//                holder.txtProductDescription.setText(model.getDescription());
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(CategoryPunch.this, ProductDetailsActivity.class);
                                                    ...
                                                    if (task.isSuccessful()) {
                                                        cartListRef.child("Orders View").child(mAuth.getCurrentUser().getUid())
                                                                ...
                                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                    ...
                                                                    public void onComplete(@NonNull @NotNull Task<Void> task) {
                                                                        if (task.isSuccessful()) {
                                                                            Toast.makeText(CategoryPunch.this, "Added to Cart Successfully", Toast.LENGTH_SHORT).show();
